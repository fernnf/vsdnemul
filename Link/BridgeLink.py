...
class DirectLinkBridge(Link):
    ...
    def delete(self):
        ...
        try:
            ...
            IpRouteApi.delete_interface(ifname = if_src, netns = pid_src)
            IpRouteApi.delete_interface(ifname = if_dst, netns = pid_dst)

            IpRouteApi.delete_interface(ifname = link_name)
