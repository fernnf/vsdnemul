...
if __name__ == '__main__':
    ...
    output = "/root/results/openvirtex/throughput/switches-100"
    try:
    ...
    statis.start()
    run_throughput_test(ths=threads, dp=dp, loop="15", macs="10000", output=output, l3addr="10.0.0.0/24",
